...
class Data_loader(data.Dataset):
    def __init__(self, pv_prior, pv_img, pv_label, nc_prior, nc_img, nc_label, train=True, transform=None, target_transform=None, download=False, crop_size=None, dataset='multiorgan'):
        ...
        self.gt_label = pv_label + nc_label
        self.img_label = pv_label_list + nc_label_list
